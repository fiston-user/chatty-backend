...
You can find the repo for the frontend built with react [here](https://github.com/fiston-user/chatty.git).
...
You'll need to copy the contents of `.env.example`, add to `.env` file and update with the necessary information.
...
```bash
git clone -b develop https://github.com/fiston-user/chatty-backend.git
cd chatty-backend
npm install
```
...
## API Endpoints
- The actual endpoints for the application can be found inside the folder named `endpoints` [https://github.com/fiston-user/chatty-backend/tree/develop/endpoints](https://github.com/fiston-user/chatty-backend/tree/develop/endpoints). 
...
## You can find the frontend code [here](https://github.com/fiston-user/chatty.git)