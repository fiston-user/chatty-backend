...
class BlockedUserQueue extends BaseQueue {
  constructor() {
    super('blockedUsers');
    this.proccessJob('addBlockedUserToDB', 5, blockedUserWorker.addBlockedUserToDB);
    this.proccessJob('removeBlockedUserFromDB', 5, blockedUserWorker.addBlockedUserToDB);
  }
