...
import { Remove } from '@image/controllers/delete-image';
...
class ImageRoutes {
  ...
  public routes(): Router {
    ...
    this.router.delete('/images/:imageId', authMiddleware.checkAuthentication, Remove.prototype.image);
    this.router.delete('/images/background/:bgImageId', authMiddleware.checkAuthentication, Remove.prototype.backgroundImage);
