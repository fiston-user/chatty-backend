...
export class Add {
  ...
  public async profileImage(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Profile image uploaded successfully' });
  }
  ...
  public async backgroundImage(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Background image uploaded successfully' });
  }
