...
export class Get {
  public async posts(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Posts retrieved', posts, totalPosts });
  }
  ...
  public async postsWithImages(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'All posts with images retrieved', posts });
  }
  ...
  public async postsWithVideos(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'All posts with videos retrieved', posts });
  }
}
