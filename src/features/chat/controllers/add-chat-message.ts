...
export class Add {
  ...
  public async message(req: Request, res: Response): Promise<void> {
    ...
    if (selectedImage.length) {
      ...
      fileUrl = `https://res.cloudinary.com/the-drod-team/image/upload/v${result.version}/${result.public_id}`;
    }
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Message sent', conversationId: conversationObjectId });
  }
