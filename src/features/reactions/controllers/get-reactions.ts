...
export class Get {
  public async reactions(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Reactions retrieved', reactions: reactions[0], count: reactions[1] });
  }
  ...
  public async singleReactionByUsername(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({
      message: 'Single reaction retrieved',
  ...
  public async reactionsByUsername(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'All reactions by username retrieved', reactions });
  }
}
